...
const ContactScreen = () => {
  return (
    <div className="crt flex flex-col items-center justify-center h-screen">
      <h2 className="text-white font-mono text-6xl mb-10">Let's Connect</h2>
      
      <div className="flex space-x-8 text-6xl md:text-8xl">
