...
const ProjectsScreen = () => {
    const projects = [
        { 
            ...
            link: 'https://github.com/jmcmillenmusic/symposium'
        },
        { 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {projects.map((project, index) => (
                        <a 
                            ...
                            className="block bg-black text-green-500 border-white border-2 p-3 font-mono text-sm md:text-base lg:text-lg transform transition-transform duration-300 hover:scale-105"
                        >
